...
export default function ContactPage() {
  ...
  // Get address and business hours based on locale
  const address =
    locale === "th" && contactInfo?.address_th
      ? contactInfo.address_th
      : contactInfo?.address_en || "";
  const businessHours =
    locale === "th" && contactInfo?.business_hours_th
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {/* Social Links */}
              <div>
                <h3 className="  font-semibold mb-4">{t("labels.followUs")}</h3>
